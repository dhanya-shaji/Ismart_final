...
export default class UpcomingSaleOrderItem extends Component {
        ...
        return (
            <View style={mainContainer ? mainContainer : styles.mainContainer}>
                <View style={styles.subContainer1}>
                    <View  onPress={this.handleOrderDetailPress} style={styles.leftContainer}>
                    ...
                    <View style={styles.rightContainer}>
                        ...
                        <CustomButton onPress={this.handleAcceptPress} activeOpacity={0.7} buttonStyle={button1Style ? button1Style : styles.button1Style} buttonTextStyle={button1TextStyle ? button1TextStyle : styles.button1TextStyle} buttonText={button1Text} />
                        <CustomButton onPress={this.handleRejectPress} activeOpacity={0.7} buttonStyle={button2Style ? button2Style : styles.button2Style} buttonTextStyle={button2TextStyle ? button2TextStyle : styles.button2TextStyle} buttonText={button2Text} /> 
                    </View>
                </View>
